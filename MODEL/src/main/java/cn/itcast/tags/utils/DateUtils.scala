...
object DateUtils {
    ...
    // 格式：年－月－日 小时：分钟：秒
    private val LONG_DATE_FORMAT: String = "yyyy-MM-dd HH:mm:ss"

    // 格式：年－月－日
    private val SHORT_DATE_FORMAT: String = "yyyy-MM-dd"
     ...
     * @return
     */
    def dateCalculate(dateStr: String, amount: Int, format: String = SHORT_DATE_FORMAT): String = {
        // a. 将日期字符串转换为Date类型
